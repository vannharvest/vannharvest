          ...
          <div className="lg:pl-4">
            ...
            <address className="not-italic space-y-3 text-gray-200">
              <p className="flex items-start">
                ...
                <span>Plot No 529 Ganga Nagar, Sector No. 28, Nigdi (PCMC, Maharashtra 411044, India</span>
              </p>
              ...
              <p className="flex items-center">
                ...
                <a href="tel:+917744005377" className="hover:text-orange-500 transition-colors">+91 7744005377</a>
              </p>
            </address>
          </div>
        </div>
